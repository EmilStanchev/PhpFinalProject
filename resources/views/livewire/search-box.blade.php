    ...
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            <input id="search-input"
                wire:model="searchValue" wire:key="{{$searchValue}}"
            ...
            <button id="clear-button" class="btn hover:text-yellow-500 hover:border-yellow-500 border-gray-950" wire:click="setSearchValue()" >Search</button>
        </div>
    </div>
{{--    <div>--}}
{{--        <h3 class="text-lg font-semibold text-gray-900 mb-3">Search by author</h3>--}}
{{--        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">--}}
{{--                            <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"--}}
{{--                                       stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500">--}}
{{--                                    <path stroke-linecap="round" stroke-linejoin="round"--}}
...
{{--                            </span>--}}
{{--            <input--}}
{{--                wire:model="authorValue"--}}
{{--                class="w-40 ml-1 bg-transparent focus:outline-none focus:border-none focus:ring-0 outline-none border-none text-xs text-gray-800 placeholder:text-gray-400"--}}
{{--                type="text" placeholder="Search for article">--}}
{{--            <button class="btn hover:text-yellow-500 hover:border-yellow-500 border-gray-950" wire:click="setAuthorValue()" >Search</button>--}}
{{--        </div>--}}
{{--    </div>--}}
</div>
